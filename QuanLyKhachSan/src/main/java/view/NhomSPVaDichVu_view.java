...
//	private int _sttNhanVienEditing;
	...
	public void updateTable() {
		...
		if(switchButton_danhSach.isSelected()) {
			if(nhomHangHoa.equals("Tất cả")) {
				for (NhomSPVaDichVuModel nhomSPVaDichVuModel : _listNhomSPVaDichVuModels) {
					if(nhomSPVaDichVuModel.getTrangThai().equals("Ho?t Ð?ng")) {
			...
			if(nhomHangHoa.equals("Sản phẩm")) {
				for (NhomSPVaDichVuModel nhomSPVaDichVuModel : _listNhomSPVaDichVuModels) {
					if(nhomSPVaDichVuModel.getTrangThai().equals("Ho?t Ð?ng") && nhomSPVaDichVuModel.getNhomHangHoa().equals("S?n ph?m")) {
						model.addRow(new Object[] {stt,nhomSPVaDichVuModel.getMaNhomSP(),nhomSPVaDichVuModel.getTenNhomSP(),nhomSPVaDichVuModel.getNhomHangHoa(),nhomSPVaDichVuModel.getGhiChu(),nhomSPVaDichVuModel.getTrangThai()});
						stt++;
					}
				}
			...
			if(nhomHangHoa.equals("Dịch vụ")) {
				for (NhomSPVaDichVuModel nhomSPVaDichVuModel : _listNhomSPVaDichVuModels) {
					if(nhomSPVaDichVuModel.getTrangThai().equals("Ho?t Ð?ng") && nhomSPVaDichVuModel.getNhomHangHoa().equals("D?ch v?")) {
						model.addRow(new Object[] {stt,nhomSPVaDichVuModel.getMaNhomSP(),nhomSPVaDichVuModel.getTenNhomSP(),nhomSPVaDichVuModel.getNhomHangHoa(),nhomSPVaDichVuModel.getGhiChu(),nhomSPVaDichVuModel.getTrangThai()});
						stt++;
					}
				}
		...
		if(!switchButton_danhSach.isSelected()) {
			if(nhomHangHoa.equals("Tất cả")) {
				for (NhomSPVaDichVuModel nhomSPVaDichVuModel : _listNhomSPVaDichVuModels) {
					if(nhomSPVaDichVuModel.getTrangThai().equals("Không Ho?t Ð?ng")) {
						model.addRow(new Object[] {stt,nhomSPVaDichVuModel.getMaNhomSP(),nhomSPVaDichVuModel.getTenNhomSP(),nhomSPVaDichVuModel.getNhomHangHoa(),nhomSPVaDichVuModel.getGhiChu(),nhomSPVaDichVuModel.getTrangThai()});
						stt++;
					}
				}
			...
			if(nhomHangHoa.equals("Sản phẩm")) {
				for (NhomSPVaDichVuModel nhomSPVaDichVuModel : _listNhomSPVaDichVuModels) {
					if(nhomSPVaDichVuModel.getTrangThai().equals("Không Ho?t Ð?ng") && nhomSPVaDichVuModel.getNhomHangHoa().equals("S?n ph?m")) {
						model.addRow(new Object[] {stt,nhomSPVaDichVuModel.getMaNhomSP(),nhomSPVaDichVuModel.getTenNhomSP(),nhomSPVaDichVuModel.getNhomHangHoa(),nhomSPVaDichVuModel.getGhiChu(),nhomSPVaDichVuModel.getTrangThai()});
						stt++;
					}
				}
			...
			if(nhomHangHoa.equals("Dịch vụ")) {
				for (NhomSPVaDichVuModel nhomSPVaDichVuModel : _listNhomSPVaDichVuModels) {
					if(nhomSPVaDichVuModel.getTrangThai().equals("Không Ho?t Ð?ng") && nhomSPVaDichVuModel.getNhomHangHoa().equals("D?ch v?")) {
						model.addRow(new Object[] {stt,nhomSPVaDichVuModel.getMaNhomSP(),nhomSPVaDichVuModel.getTenNhomSP(),nhomSPVaDichVuModel.getNhomHangHoa(),nhomSPVaDichVuModel.getGhiChu(),nhomSPVaDichVuModel.getTrangThai()});
						stt++;
					}
				}
